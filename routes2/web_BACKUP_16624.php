...
Route::group(['middleware' => 'cekakses', 'auth:web'], function () {
    ...
    Route::get('pasien/invite', ['as' => 'pasien.invite_view', 'uses' => 'M_PasienController@invite_view']);
    Route::post('pasien/invite', ['as' => 'pasien.invite_submit', 'uses' => 'M_PasienController@invite_submit']);
...
Route::group(['middleware' => 'cekaksespasien', 'auth:pasien'], function () {
    Route::get('home_pasien', 'HomePSController@index')->name('home');
