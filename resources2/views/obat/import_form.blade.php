        ...
        <div class="form-group col-12">
            <div class="card card-default card-outline">
                <div class="card-body">
                    ...
                    <form id="form-import-barang" method="POST" action="{{url('obat/uploaddata')}}" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-center">
                                ...
                                <a class="btn btn-sm btn-outline-danger" href="{{ url('obat') }}">Cancel</a> 
                            </div>
                        </div>
...
@section('script')<script type="text/javascript">
    ...
    $("#form-import-barang").submit(function(event){
