...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$(".btnAddDetail").click(function(e){
			...
			$.ajax({
				type:"GET",
				url : '{{url("jurnalpenyesuaian/adddetail")}}/',
				dataType : "json",
				data : {count:count},
		...
		$(".btnAddFile").click(function(e){
			...
			$.ajax({
				type:"GET",
				url : '{{url("jurnalpenyesuaian/addfile")}}/',
				dataType : "json",
				data : {count:count},
				beforeSend: function(data){
					// replace dengan fungsi loading
		...
		$("#form_jurnal").submit(function(e){
			...
			if($(this).valid() == true){
	        	...
	        	$(".buktifile").each(function(i, obj) {
	        		formData.append('buktifile[]', $(this).prop('files')[0]);
	        	});
	...
	{
		$.get('{{url("jurnalpenyesuaian/viewFile/")}}/'+id,{id:id}, function (data) {
