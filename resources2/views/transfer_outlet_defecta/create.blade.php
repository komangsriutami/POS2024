...
{!! Form::model(new App\TransaksiTO, ['route' => ['transfer_outlet.store'], 'class'=>'validated_form', 'id'=> 'form_transfer_outlet', 'name' => 'form_transfer_outlet']) !!}
    <div class="row" id="divfix">
        <div class="col-sm-12">
            <div class="callout callout-success">
                <a class="btn btn-info text-white" style="text-decoration: none;" type="button" href="{{ url('transfer_outlet/permintaan_transfer')}}" data-toggle="tooltip" data-placement="top" title="List Data Transfer Outlet"><i class="fa fa-home"></i></a> 
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-info card-outline">
                <div class="card-body">
                    @include('transfer_outlet_defecta/_form', ['submit_text' => 'Create'])
                </div>
            </div>
        </div>
    </div>
...
@section('script')
    @include('transfer_outlet_defecta/_form_js')
@endsection
