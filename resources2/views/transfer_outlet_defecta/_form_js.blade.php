<script type="text/javascript">
    ...
    var tb_nota_transfer_outlet = $('#tb_nota_transfer_outlet').dataTable( {
            ...
            paging: false,
            ajax:{
                    url: '{{url("transfer_outlet/list_detail_transfer_outlet_defecta")}}',
                    data:function(d){
                        d.id = $("#id").val();
                        d.id_det_transfer = $("#details").val();
                }
            },
            columns: [
            ...
            drawCallback: function( settings ) {
                ...
                //$("#total_pembayaran_display").html(total_rp);
    ...
    function edit_detail_from_transfer(no, id_detail_transfer, id_obat){
        $.ajax({
            type: "POST",
            url: '{{url("transfer_outlet/edit_detail_from_transfer")}}',
            async:true,
            data: {
                _token:"{{csrf_token()}}",
                no : no,
