                    ...
                    <div class="blog-view">
                        <div class="blog blog-single-post">
                            <div class="blog-image">
                                <a href="javascript:void(0);"><img alt="" src="assets_frontend/img/blog/blog-01.jpg"
                                        class="img-fluid"></a>
                            </div>
                                ...
                                <div class="about-author">
                                    <div class="about-author-img">
                                        <div class="author-img-wrap">
                                            <a href="doctor-profile"><img class="img-fluid rounded-circle" alt=""
                                                    src="assets_frontend/img/doctors/doctor-thumb-02.jpg"></a>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body pb-0">
                                <ul class="comments-list">
                                    <li>
                                        <div class="comment">
                                            <div class="comment-author">
                                                <img class="avatar" alt="" src="assets_frontend/img/patients/patient4.jpg">
                                            </div>
                                        ...
                                        <ul class="comments-list reply">
                                                ...
                                                <div class="comment">
                                                    <div class="comment-author">
                                                        ...
                                                        <img class="avatar" alt=""
                                                            src="assets_frontend/img/patients/patient5.jpg">
                                            ...
                                            <li>
                                                <div class="comment">
                                                    <div class="comment-author">
                                                        <img class="avatar" alt=""
                                                            src="assets_frontend/img/patients/patient3.jpg">
                                                    </div>
                                                    <div class="comment-block">
                                                        <span class="comment-by">
                                    ...
                                    <li>
                                        <div class="comment">
                                            <div class="comment-author">
                                                <img class="avatar" alt="" src="assets_frontend/img/patients/patient6.jpg">
                                            </div>
                                            <div class="comment-block">
                                                <span class="comment-by">
                                    ...
                                    <li>
                                        <div class="comment">
                                            <div class="comment-author">
                                                <img class="avatar" alt="" src="assets_frontend/img/patients/patient7.jpg">
                                            </div>
                                            <div class="comment-block">
                                                <span class="comment-by">
