    ...
    <div id="page-wrapper">
        ...
        <div class="container large-padding">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6">
                    <form action="{{route('login_post')}}" id="login-validation" class="center-margin" method="POST">
                            ...
                            <div class="content-box-wrapper pad20A">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="kode_apotek" id="kode_apotek" value="{{ old('kode_apotek') }}" class="form-control @error('kode_apotek') is-invalid @enderror" autocomplete="kode_apotek" autofocus placeholder="Kode Apotek">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                        ...
                        <p class="text-red">Note | Isikan kode outlet untuk staff outlet.</p>
                    </form>
                </div>
            </div>
        </div>
