...
[
'text' => (Request::get('nama') || Request::get('spesialis')) ? 'Cari Apotek' : 'Semua',
'active' => true,
				...
				<div class="doctor-widget">
					<div class="doc-info-left">
						<div class="doctor-img">
							<img src="../../assets_frontend/img/apotek.png" class="img-fluid" alt="User Image">
						</div>
						<div class="doc-info-cont">
							<h4 class="doc-name">{{$apoteks->nama_panjang}}</h4>
							...
							<div class="clinic-details">
								<p>{{$apoteks->telepone}}</p>
								<p class="doc-location"><i class="fas fa-map-marker-alt"></i> {{$apoteks->alamat}} - <a href="javascript:void(0);">Get Directions</a></p>
