                  ...
                  <tr bgcolor="white">
                     <td style="padding:20px 20px 10px">
                        <table style="border-spacing:0;border-collapse:collapse;width:100%">
                           <tbody>
                              <tr>
                                 <td><span style="color: #636363;"> Hi <b style="color: #636363;">{{ $data['apoteker']['nama']}}, </b></span>
                                 </td>
                              </tr>
                              <tr>
                                 <td>
                                    <p style="color:#636363;line-height: 1.6;" align="justify">
                                       Terima kasih telah melakukan pendaftaran sebagai apoteker! Klik link di bawah ini untuk melakukan aktivasi akun Anda.
                                    </p>
                                 </td>
                              </tr>
                              <hr>
