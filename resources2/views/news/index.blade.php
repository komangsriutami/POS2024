...
@section('content')
    <div class="card card-info card-outline mb-12 border-left-primary">
        <div class="card-body">
            ...
            <a class="btn btn-success w-md m-b-5" href="{{ url('news/create') }}"><i class="fa fa-plus"></i> Tambah
                Data</a>
        </div>
    </div>
    ...
    <div class="card card-info card-outline" id="main-box" style="">
        ...
        <div class="card-body">
            <table id="tb_news" class="table table-bordered table-striped table-hover">
                <thead>
                    <tr>
                        <th width="5%">No.</th>
    ...
    <script type="text/javascript">
        ...
        function edit_data(id) {
            $.ajax({
                ...
                beforeSend: function(data) {
                    ...
                    $("#modal-xl .modal-title").html("Edit Data - News");
                    $('#modal-xl').modal("show");
        ...
        function submit_valid(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data == 1) {
                        show_info("Data News berhasil disimpan!");
            ...
            swal({
                ...
                function() {
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data == 1) {
                                swal("Deleted!", "Data News berhasil dihapus.", "success");
                            } else {

                                swal("Failed!", "Gagal menghapus Data News.", "error");
                            }
                        },
                        complete: function(data) {
                            // tb_news.fnDraw(false);
        ...
        function show_data(id) {
            $.ajax({
                ...
                beforeSend: function(data) {
                    ...
                    $('#modal-xl').find('.modal-xl').find(".modal-content").find(".modal-header").attr("class",
                        "modal-header bg-light-blue");
                    $("#modal-xl .modal-title").html("Detail Data - News");
                    $('#modal-xl').modal("show");
                    $('#modal-xl').find('.modal-body-content').html('');
                    $("#modal-xl").find(".overlay").fadeIn("200");
                },
