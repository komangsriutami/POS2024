<script type="text/javascript">
	            ...
	            success:function(data){
	            	if(data.is_data == 1) {
	            		if(data.harga_stok.harga_jual < data.harga_stok.harga_beli_ppn) {
			                ...
			                $("#hb_ppn").val(data.harga_stok.hb_ppn);
	...
	function tambah_item_obat(){
		...
		if(is_kredit == 1 && id_vendor == "") {
			show_error("Penjualan melalui belum dipilih, silakan pilih kategori tersebut terlebih dahulu !");
		 	...
		 	var nama_obat = $('#nama_obat').val();
	        var harga_jual = $("#harga_jual").val();
	        var harga_jual_rp = hitung_rp_khusus(harga_jual);
	        var stok_obat = parseFloat($("#stok_obat").val());
	        var diskon = $("#diskon").val();
	        var diskon_rp = hitung_rp_khusus(diskon);
	...
	function hitung_total(){
       ...
       /* $(diskon).each(function(i,l){
        ...
        var biaya_apd_rp = hitung_rp_khusus(biaya_apd);
