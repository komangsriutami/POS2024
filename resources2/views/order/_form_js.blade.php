<script type="text/javascript">
	...
	function tambah_item_obat(){
        ...
        var markup = "<tr>"+
        				...
        				"<td><input type='hidden' id='detail_order["+counter+"][id_satuan]' name='detail_order["+counter+"][id_satuan]' value='"+id_satuan+"' class='jumlah' data-id-obat='"+id_obat+"'><span class='id_satuan_label'>" + satuan + "</span></td>"+
