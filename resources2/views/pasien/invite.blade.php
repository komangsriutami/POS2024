...
@section('content')
    {!! Form::model(new App\MasterPasien(), ['route' => ['pasien.invite_submit'], 'class' => 'validated_form']) !!}
    <div class="row">
        <div class="col-sm-12">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            {!! Form::text('nama', $pasien->nama, ['class' => 'form-control required', 'placeholder' => 'Masukan Nama']) !!}
                        </div>
                        <div class="form-group col-md-6">
                            {!! Form::label('email', 'Email') !!}
                            {!! Form::text('email', $pasien->email, ['class' => 'form-control required', 'placeholder' => 'Masukan Email']) !!}
                        </div>
