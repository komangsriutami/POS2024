            ...
            <div class="card card-info card-outline">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            {!! Form::label('harga_beli_new', 'Harga Beli') !!}
                            <div class="input-group">
                        ...
                        ?>
                        <div class="form-group col-md-3">
                            {!! Form::label('total_harga_new', 'Total I') !!}
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                        ...
                        <div class="form-group col-md-3">
                            {!! Form::label('diskon_persen_new', 'Diskon Persen') !!}
                            <div class="input-group">
                        ...
                        <div class="form-group col-md-3">
                            {!! Form::label('tgl_batch_new', 'Tanggal Expired') !!}
                             {!! Form::text('tgl_batch_new', $detail->tgl_batch, array('class' => 'form-control', 'placeholder'=>'Masukan Tanggal Batch', 'id' => 'tgl_batch_new')) !!}
                        </div>
                        <div class="form-group col-md-3">
                            {!! Form::label('id_batch_new', 'ID Batch') !!}
...
<script type="text/javascript">
    ...
    function set_detail_new(obj, no){
        ...
        $("#total_harga_lbl_"+no).html(total_harga);
        $("#diskon_lbl_"+no).html(diskon);
        $("#diskon_persen_lbl_"+no).html(diskon_persen);
        $("#total_2_lbl_"+no).html(total);
        $("#jumlah_lbl_"+no).html(jumlah_rev);
        $("#harga_beli_lbl_"+no).html(harga_beli);
