        ...
        @if($filebukti->id != "")
            <div class="col-sm-2 form-group">
                <div class="btn-group">
                    ...
                    <div class="mb-1 btn btn-outline-primary" onclick="openfile('{{Crypt::encrypt($filebukti->id)}}')"><i class="fa fa-search"></i> Lihat file bukti</div>
                </div>
            </div>
        @else
            <div class="col-sm-4 form-group">
                <div class="input-group">
                    ...
                    <input class="form-control buktifile text-right" placeholder="buktifile" type="file" name="buktifile[{{$count}}]" data-idx="{{$count}}" required>
                </div>
            </div>
        @endif   
