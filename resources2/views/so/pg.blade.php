...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var editor = new $.fn.dataTable.Editor({
            ajax: "{{ url('/stok_opnam_outlet/puri_gading') }}",
        ...
        $('#so_status_aktif').change(function(){
            $.ajax({
                url:'{{url("stok_opnam_outlet/puri_gading/set_so_status_aktif")}}',
                type: 'POST',
                data: {
                    _token      : "{{csrf_token()}}",
                ...
                success:function(data){
                    //location.reload();
                    window.location.href = "{{ url('stok_opnam_outlet/puri_gading') }}";
                }
            });
        });        
    })
    ...
    function export_data(){
        window.open("{{ url('stok_opnam_outlet/puri_gading/export') }}","_blank");
    }
    ...
    function reload_stok_awal(id){
        ...
        function(){
            $.ajax({
                type: "POST",
                url: '{{url("stok_opnam_outlet/puri_gading/reload_stok_awal")}}',
                async:true,
                data: {
                    _token:token,
                    id:id,
