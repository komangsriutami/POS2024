...
class TipsController extends Controller
{
    ...
    public function list_tips(Request $request)
    {
        ...
        return $datatables
            ...
            ->addcolumn('action', function ($data) {
                ...
                $btn .= '<span class="btn btn-info" onClick="show_data(' . $data->id . ')" data-toggle="tooltip" data-placement="top" title="Show Data"><i class="fa fa-eye"></i></span>';
                $btn .= '<a class="btn btn-primary" href="'.url('tips/'.$data->id.'/edit').'" data-toggle="tooltip" data-placement="top" title="Edit Data"><i class="fa fa-edit"></i></a>';
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return view('tips.create')->with(compact('data_'))->withErrors($validator);
        } else {
            $data_->save();
            if ($data_->save()) {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            Session()->flash('error', 'Gagal menyimpan data!');
            return view('tips.edit')->with(compact('data_'))->withErrors($validator);
        } else {
            if ($data_->save()) {
                Session()->flash('success', 'Sukses menyimpan data!');
                return redirect('/tips');
