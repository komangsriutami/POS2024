    ...
    public function handle()
    {
        ...
        if(!empty($cek)) {
            ...
            if($last_id_obat_ex >= $last_id_obat) {
                # selesai : 1. hapus data di tb_bantu_update_sg dan ulang dari 0
                DB::table('tb_bantu_update_sg')->truncate();
                $skip = 1;
            } else {
        ...
        if($skip != 1) {
            ...
            if($x > 0) { 
                ...
                \Log::info("Cron SG history not working! Reload data ".$last_id_obat_ex.' until '.$last_id_obat_after);
            }
        } else {
