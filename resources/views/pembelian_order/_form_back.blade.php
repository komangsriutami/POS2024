                                    ...
                                    @foreach($detail_pembelians as $detail_pembelian)
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                {!! Form::hidden('detail_pembelian['.$no.'][id_detail_order]', $detail_pembelian['id_detail_order'], array('id' => 'id_detail_order_'.$no, 'class' => 'form-control', 'placeholder'=>'ID', 'readonly' => 'readonly')) !!}
                                            </td>
                                            ...
                                            <td>
                                                {!! Form::hidden('detail_pembelian['.$no.'][nama_obat]', $detail_pembelian['nama_obat'], array('id' => 'nama_obat_'.$no, 'class' => 'form-control', 'placeholder'=>'Nama Obat', 'readonly' => 'readonly')) !!}
                                                {{ $detail_pembelian['nama_obat'] }}  
                                            ...
                                            <td style='text-align:right;'>
                                                ...
                                                <span id="total_harga_lbl_{{$no}}"><b>{{ $detail_pembelian['total_harga'] }}</b></span>
                                            </td>
                                            <td style='text-align:right;'>
                                                ...
                                                <span id="diskon_lbl_{{$no}}">{{ $detail_pembelian['diskon'] }}</span>
                                            </td>
                                            <td style='text-align:center;'>
                                                ...
                                                <span id="diskon_persen_lbl_{{$no}}">{{ $detail_pembelian['diskon_persen'] }}</span>
                                            </td>
                                            <td style='text-align:right;'>
                                                ...
                                                <span id="total_2_lbl_{{$no}}">{{ $total_2 }}
                                            </td>
                                            <td style='text-align:center;'>
                                                ...
                                                <span id="jumlah_lbl_{{$no}}">{{ $detail_pembelian['jumlah'] }}</span>
                                            </td>
                                            <td style='text-align:right;'>
                                                ...
                                                <span id="harga_beli_lbl_{{$no}}">{{ $detail_pembelian['harga_beli'] }}</span>
                                            </td>
