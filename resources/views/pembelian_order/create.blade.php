    ...
    <div class="row" id="divfix">
        <div class="col-sm-12">
            <div class="callout callout-success">
                <a class="btn btn-info text-white" style="text-decoration: none;" type="button" href="{{ url('pembelian/konfirmasi_barang_datang/'.encrypt($order->id))}}" data-toggle="tooltip" data-placement="top" title="List Data Pembelian"><i class="fa fa-home"></i></a> 
...
@section('script')
    @include('pembelian_order/_form_js')
@endsection
