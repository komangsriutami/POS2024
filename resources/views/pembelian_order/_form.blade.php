...
<div class="row">
    ...
    {!! Form::hidden('id_nota_order', $order->id, array('class' => 'form-control', 'id'=>'id_nota_order')) !!}
...
?>
<hr style="border: 1px solid #004d40; padding: 0px; margin-top: 0px; margin-bottom: 10px;">
@if($pembelian->is_lunas != 1 AND $pembelian->is_sign != 1 OR Auth::user()->is_admin == 1)
<div class="row">
    <div class="form-group col-md-2">
        ...
        <div class="box box-success" id="detail_data_pembelian">
            <div class="box-body">
                <div class="table-responsive">
                    <table id="tb_nota_pembelian" class="table table-bordered" width="100%">
                        <thead>
