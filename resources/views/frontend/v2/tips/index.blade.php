...
@section('content')
    ...
    @include('frontend.v2.components.breadcrumb', [
        ...
        'data' => [
            ...
            [
                'text' => (Request::get('title')) ? 'Cari Tips' : 'Semua',
                'active' => true,
            ...
            <div class="row">
                @if(count($tipss) > 0)
                    <div class="col-lg-8 col-md-12">
                        <!-- Blog Post -->
                        @foreach ($tipss as $item)
                        <div class="blog">
                            <div class="blog-image">
                                <a href="{{ url('/homepage/tips/'.$item->slug) }}">
                                    <img class="img-fluid" alt="User Image" src="{{'data:image/png;base64,'.$item->image}}">
                                </a>
                            </div>
                            <h3 class="blog-title"><a href="{{ url('/homepage/tips/'.$item->slug) }}">{!! $item->title !!}</a></h3>
                            <div class="blog-info clearfix">
                                <div class="post-left">
                                    <ul>
                                        <li>
                                            <div class="post-author">
                                                <a><img src="../assets_frontend/img/doctors/doctor-thumb-01.jpg"
                                                alt="Post Author"> <span>By Admin</span></a>
                                            </div>
                                        </li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="blog-pagination">
                                    @include('frontend.v2.components.pagination', ['paginator' => $tipss])
                                </div>
                            </div>
                        </div>
                        <!-- /Blog Pagination -->
                        ...
                        <div class="card-body">
                            <ul class="latest-posts">
                                ...
                                <li>
                                    ...
                                    <div class="post-info">
                                        <h4>
                                            <a href="{{ url('/homepage/tips/'.$item->slug) }}">{!! $item->title !!}</a>
                                        </h4>
