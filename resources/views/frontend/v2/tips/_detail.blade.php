                            ...
                            <div class="blog blog-single-post">
                                <div class="blog-image">
                                    <a href="javascript:void(0);">
                                        ...
                                        {{-- <img alt="" src="../../assets_frontend/img/blog/blog-01.jpg" class="img-fluid"> --}}
                                    </a>
                                </div>
                                ...
                                <div class="blog-info clearfix">
                                    <div class="post-left">
                                        <ul>
                                            ...
                                            <li><i class="far fa-calendar"></i>{{\Carbon\Carbon::parse($item->created_at)->format('d M Y')}}</li>
                                ...
                                <li>
                                    <div class="post-thumb">
                                        <a href="{{ url('/homepage/tips/'.$item->slug) }}">
                                            <img class="img-fluid" src="{{'data:image/png;base64,'.$item->image}}">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
