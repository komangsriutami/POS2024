...
'title' => 'Konsultasi Apotek',
'data' => [
[
'text' => 'Konsultasi Apotek',
'active' => false,
'href' => request()->url()
],
[
'text' => (Request::get('nama')) ? 'Cari Apotek' : 'Semua',
'active' => true,
                    ...
                    <div class="col-xs-12 col-md-4 col-xs-3">
                        <div class="profile-widget">
                            ...
                            <div class="pro-content">
                                <h3 class="title">
                                    <a href="doctor-profile">{{ $item->nama_panjang }} <i class="fas fa-check-circle verified"></i></a>
                                </h3>
                                <div class="rating">
                                ...
                                <div class="row row-sm">
                                    <div class="col-6">
                                        <a href="{{ url('/apotek_detail/'.$item->id) }}" class="btn view-btn">Profil</a>
                                    </div>
                                    <div class="col-6">
