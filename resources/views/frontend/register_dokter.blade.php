            ...
            <div class="col-md-12 col-12">
                <nav aria-label="breadcrumb" class="page-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Register Dokter</li>
                    </ol>
                </nav>
                <h2 class="breadcrumb-title">Register Dokter</h2>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-md-12 col-lg-6 login-right">
                            <div class="login-header">
                                <h3>Registrasi Dokter</a></h3>
                            </div>
                            <!-- Register Form -->
                            <form action="{{route('register_dokter_post')}}" method="POST">
                                {{csrf_field()}}
                                @if (session('status'))
