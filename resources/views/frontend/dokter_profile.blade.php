				...
				<div class="doctor-widget">
					<div class="doc-info-left">
						<div class="doctor-img">
							<img onerror="this.onerror=null; this.src=`{{ asset('assets_frontend/img/doctors/doctor-thumb-02.jpg') }}`" src="{{'data:image/png;base64,'.$dokters->image}}" class="img-fluid" alt="User Image">
						</div>
						<div class="doc-info-cont">
							<h4 class="doc-name">{{$dokters->nama}}</h4>
							<p class="doc-department">{{$dokters->spesialis}}</p>
							<div class="rating">
							...
							<div class="clinic-details">
								<p class="doc-location"><i class="fas fa-map-marker-alt"></i> {{$dokters->alamat}} <a href="javascript:void(0);">Get Directions</a></p>
								<ul class="clinic-gallery">
									<li>
										<a href="{{ asset('assets_frontend/img/features/feature-01.jpg') }}" data-fancybox="gallery">
											<img src="{{ asset('assets_frontend/img/features/feature-01.jpg') }}" alt="Feature">
										</a>
									</li>
									<li>
										<a href="{{ asset('assets_frontend/img/features/feature-02.jpg') }}" data-fancybox="gallery">
											<img src="{{ asset('assets_frontend/img/features/feature-02.jpg') }}" alt="Feature Image">
										</a>
									</li>
									<li>
										<a href="{{ asset('assets_frontend/img/features/feature-03.jpg') }}" data-fancybox="gallery">
											<img src="{{ asset('assets_frontend/img/features/feature-03.jpg') }}" alt="Feature">
										</a>
									</li>
									<li>
										<a href="{{ asset('assets_frontend/img/features/feature-04.jpg') }}" data-fancybox="gallery">
