<div class="col-xs-12">
	<div id="div_form">
		{!! Form::model(new App\Biaya, ['route' => ['biaya.import_biaya_from_excel'], 'class'=>'validated_form', 'files'=> true, 'id' => "form-import"]) !!}
		    ...
		    <div class="col-sm-12">
		    	<div class="callout callout-info row">
			        ...
			        <div class="col-sm-11">
			        	...
			        	<i style="">
			        		*) Template berisikan header sesuai dengan data yang dibutuhkan untuk mengimport biaya.
			        	</i><br><br>
			        	<a href="{{url('biaya/gettemplate')}}" class="btn btn-block btn-info btn-sm text-white"><i class="fa fa-download"></i>&nbsp;Download template *.xls</a>
			        </div>
			    </div>
		    </div>
		</div>
		    ...
		    <div class="col-sm-12">
		    	<div class="callout callout-info row">
			        ...
			        <div class="col-sm-11">
			        	...
			        	<i style="">
			        		*) Salin/masukan data anda ke dalam template <b>tanpa menghapus header</b>.<br>
