    ...
    <div class="card-body login-card-body">
      ...
      <form method="POST" action="{{ route('login_post') }}">
        ...
        <div class="input-group mb-3">
          <input id="kode_apotek" type="kode_apotek" class="form-control @error('kode_apotek') is-invalid @enderror" name="kode_apotek" value="{{ old('kode_apotek') }}" autocomplete="kode_apotek" autofocus placeholder="Kode Apotek">
