...
<html>
    ...
    <style type="text/css">
        .sidebar-mini.sidebar-collapse .main-sidebar .nav-sidebar .nav-link .notif-badge{
            visibility: hidden;
        }
        .sidebar-mini.sidebar-collapse .main-sidebar:hover .nav-sidebar .nav-link .notif-badge{
            visibility: visible;
        }
        .nav-sidebar .nav-link>.right.notif-section{
            top: 0.5rem;
        }
