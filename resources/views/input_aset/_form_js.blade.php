<script type="text/javascript">
    ...
    function open_data_aset(kode_aset) {
        $.ajax({
            type: "POST",
            url: '{{url("input_aset/open_data_aset")}}',
            async:true,
            data: {
                _token  : "{{csrf_token()}}",
                kode_aset : kode_aset,
    ...
    function add_item_dialog(id_aset) {
        $.ajax({
            url:'{{url("input_aset/cari_aset_dialog")}}',
            type: 'POST',
            data: {
                _token      : "{{csrf_token()}}",
                id_aset: id_aset
    ...
    function edit_detail(no, id){
        $.ajax({
            type: "POST",
            url: '{{url("input_aset/edit_detail")}}',
            async:true,
            data: {
                _token:"{{csrf_token()}}",
                no : no,
    ...
    function hapus_detail(r, id){
        ...
        function(){
            $.ajax({
                type: "DELETE",
                url: '{{url("input_aset/hapus_detail/")}}/'+id,
                async:true,
                data: {
                    _token:token,
                    id:id
