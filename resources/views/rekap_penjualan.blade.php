...
@section('content')
    ...
    <div class="card card-info card-outline" id="main-box" style="">
        ...
        <div class="card-body">
            <div class="overlay-wrapper" id="overlay-wrapper-rekap-penjualan-id">
                <div class="overlay" id="overlay-rekap-penjualan-id">
                </div>
                 <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card card-secondary">
                            <div class="card-header border-transparent">
                                <h3 class="card-title text-center">REKAP PENJUALAN SELURUH OUTLET</h3>
                            ...
                            <table class="table table-bordered table-striped table-hover" id="data_rekap_penjualan">
                                <thead>
                                    <tr>
...
<script type="text/javascript">
    ...
    var overlay = document.getElementById('overlay-wrapper-rekap-penjualan-id');
    var overlaybody = document.getElementById('overlay-rekap-penjualan-id');
    ...
    function getData() {
        $.ajax({
            type: "GET",
            url: '{{ url("home/cari_info_penjualan") }}',
            async: true,
            data: {
                _token: token,
            ...
            success: function(data) {
                $("#data_rekap_penjualan tbody").append(data);
            },
