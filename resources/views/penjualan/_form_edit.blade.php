                        ...
                        @else
                            ...
                            <tr>
                                ...
                                <td style='text-align:right;'>
                                     <input type="hidden" name="detail_penjualan[{{$no}}][margin]" id="margin_{{$no}}" value="{{ $detail_penjualan->margin}}">
                                    <input type="hidden" name="detail_penjualan[{{$no}}][hb_ppn]" id="hb_ppn_{{$no}}" value="{{ $detail_penjualan->hb_ppn}}">
