...
<div class="row">
    ...
    <div class="col-sm-4">
        <?php
            if($penjualan->id_pasien == '' OR !is_null($penjualan->id_pasien)) {
...
<div class="row">
    ...
    <div class="form-group col-md-2">
        ...
        <div class="input-group">
            ...
            @if(is_null($penjualan->id_pasien))  
                {!! Form::text('pasien', null, array('id' => 'pasien', 'class' => 'form-control', 'placeholder'=>'Masukan Nama Pasien')) !!}
            @else
                {!! Form::text('pasien', $penjualan->pasien->nama, array('id' => 'pasien', 'class' => 'form-control form-control-border', 'placeholder'=>'Masukan Nama Pasien')) !!}
            @endif
            <div class="input-group-append">
                ...
                <span class="btn btn-info"  data-toggle="modal" data-placement="top" title="Add Member" onclick="add_member('')"><i class="fa fa-plus"></i></span>
            </div>
        </div>
    </div>
    <div class="form-group col-md-2">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-2">
            ...
            <div class="input-group">
                ...
                {!! Form::hidden('hb_ppn', $penjualan->hb_ppn, array('id' => 'hb_ppn', 'class' => 'form-control', 'placeholder'=>'HB+ppn', 'readonly' => 'readonly')) !!}
                {!! Form::hidden('harga_jual_default', $penjualan->harga_jual, array('id' => 'harga_jual_default', 'class' => 'form-control', 'placeholder'=>'Masukan Obat')) !!}
                {!! Form::hidden('margin', $penjualan->margin, array('id' => 'margin', 'class' => 'form-control', 'placeholder'=>'Masukan Obat')) !!}
            </div>
        </div>
        <div class="form-group col-md-2">
            ...
            <div class="box-body">
                    <table id="tb_nota_penjualan" class="table table-bordered table-striped table-hover table-head-fixed text-nowrap mb-0" width="100%">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <td colspan="3">
                                    <span id="nama_apd_input">APD : </span>
                                    @if($penjualan->total_bayar == 0 OR is_null($penjualan->total_bayar)) 
