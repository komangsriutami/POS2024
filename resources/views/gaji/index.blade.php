...
@section('content')
	...
	<div class="card card-info card-outline" id="main-box" style="">
        ...
        <div class="card-body">
			<table  id="tb_gaji" class="table table-bordered table-striped table-hover">
		    	<thead>
			        <tr>
			            <th width="5%">No.</th>
			            <th width="40%">Nama</th>
...
<script type="text/javascript">
	...
	var tb_gaji = $('#tb_gaji').dataTable( {
			processing: true,
	        serverSide: true,
	        stateSave: true,
	        ajax:{
			        url: '{{url("gaji/list_gaji")}}',
			        data:function(d){
				         }
			     },
	        columns: [
	            ...
	            {data: 'id_posisi', name: 'id_posisi'},
	            {data: 'id_status_karyawan', name: 'id_status_karyawan'},
