<div class="col-xs-12">
	<div id="div_form">
		{!! Form::model(new App\JurnalUmum, ['route' => ['jurnalpenyesuaian.import_jurnal_from_excel'], 'class'=>'validated_form', 'files'=> true, 'id' => "form-import"]) !!}
		    ...
		    <div class="col-sm-12">
		    	<div class="callout callout-info row">
			        ...
			        <div class="col-sm-11">
			        	...
			        	<a href="{{url('jurnalpenyesuaian/gettemplate')}}" class="btn btn-block btn-info btn-sm text-white"><i class="fa fa-download"></i>&nbsp;Download template *.xls</a>
			        </div>
			    </div>
		    </div>
		</div>
		    	...
		    	<div class="callout callout-info row">
			        ...
			        <div class="col-sm-11">
			        	...
			        	<i style="">
			        		...
			        		*) Data dengan Header bertanda (*) wajib diisi.
			        	</i>
			        </div>
			    </div>
		    </div>
