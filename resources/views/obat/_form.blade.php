...
<div class="row">
    ...
    <div class="form-group col-md-6">
        {!! Form::label('zat_aktif', 'Zat Aktif') !!}
        <div class="input-group">
            {!! Form::textarea('zat_aktif', $obat->zat_aktif, array('id' => 'zat_aktif', 'class' => 'form-control required', 'rows' => 5, 'placeholder'=>'Masukan Zat Aktif')) !!}
        </div>
    </div>
    <div class="form-group col-md-6">
        {!! Form::label('bentuk_kekuatan_sediaan', 'Bentuk Kekuatan Kesediaan') !!}
        <div class="input-group">
            {!! Form::textarea('bentuk_kekuatan_sediaan', $obat->bentuk_kekuatan_sediaan, array('id' => 'bentuk_kekuatan_sediaan', 'class' => 'form-control required', 'rows' => 5, 'placeholder'=>'Masukan Bentuk Kekuatan Kesediaan')) !!}
        </div>
    </div>
</div>