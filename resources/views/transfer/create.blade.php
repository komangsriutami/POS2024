...
@section('title')
Nota Permintaan Transfer
 <a class="btn bg-navy margin" href="#" onclick="find_ketentuan_keyboard()"><i class="fa fa-bookmark-o"></i> Kode Keyboard | F10</a>
@endsection

@section('breadcrumb')
<ol class="breadcrumb float-sm-right">
    <li class="breadcrumb-item"><a href="#">Transfer Outlet</a></li>
    <li class="breadcrumb-item"><a href="#">Nota Permintaan Transfer</a></li>
    ...
    <div class="row" id="divfix">
        <div class="col-sm-12">
            <div class="callout callout-success">
                <a class="btn btn-info text-white" style="text-decoration: none;" type="button" href="{{ url('transfer/data_transfer')}}" data-toggle="tooltip" data-placement="top" title="List Data Transfer"><i class="fa fa-home"></i></a> 
