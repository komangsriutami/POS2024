...
@section('title')
Transaksi Transfer Outlet - Margin
...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item"><a href="#">Transaksi Transfer Outlet - Margin</a></li>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-info card-outline">
                <div class="card-body">
                    @include('transfer_outlet/_form_margin', ['submit_text' => 'Create'])
                </div>
            </div>
        </div>
    </div>
