...
@section('content')
    ...
    <div class="card card-info card-outline" id="main-box" style="">
        ...
        <div class="card-body">
             <div class="overlay-wrapper" id="overlay-wrapper-rekap-pembelian-id">
                <div class="overlay" id="overlay-rekap-pembelian-id">
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card card-secondary">
                            <div class="card-header border-transparent">
                                <h3 class="card-title text-center">REKAP PEMBELIAN SELURUH OUTLET</h3>
                            ...
                            <table class="table table-bordered table-striped table-hover" id="data_rekap_pembelian">
                                <thead>
                                    <tr>
...
<script type="text/javascript">
    ...
    var overlay = document.getElementById('overlay-wrapper-rekap-pembelian-id');
    var overlaybody = document.getElementById('overlay-rekap-pembelian-id');
    ...
    function getData() {
        $.ajax({
            type: "GET",
            url: '{{ url("home/cari_info_pembelian") }}',
            async: true,
            data: {
                _token: token,
            ...
            success: function(data) {
                $("#data_rekap_pembelian tbody").append(data);
            },
